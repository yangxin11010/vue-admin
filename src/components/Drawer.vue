            ...
            <div v-if="showClose && showDrawerIcon" class="drawer-icon-box" :class="drawerIconClassName">
                ...
                >
                    <el-tooltip class="item" effect="dark" placement="left" :disabled="tipDisabled">
                        ...
                        <div class="drawer-icon" @click.stop="toggle">
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const defaultWidth = computed(() => {
            if (typeof props.width === "number" && props.width < 375) return props.width + "px";
            const dwidth = typeof props.width === "string" ? props.width : props.width + "px";
            return width.value > 1000 ? dwidth : width.value > 800 ? "40%" : width.value > 500 ? "50%" : "80%";
        });
        // 默认宽度 非响应式
        // const defaultWidth = computed(() => {
